...
public class TourDatabase {
    ...
    public List<Tour> searchTours(String query) throws SQLException {
        ...
        List<Tour> tours = extractToursFromResultSet(rs);

        return tours;
    }

    public List<Tour> searchTourbyDateandLoc(String location, String date) throws SQLException {
    ...
    public void decrementAvailableSpace(int tourID, int numSpots) throws SQLException {
...
*/
    ...
    public List<Tour> getAllTours() throws SQLException {
        ...
        if (!tours.isEmpty()) {
            ...
            logger.log(Level.SEVERE, "Failed to retrieve tours");
